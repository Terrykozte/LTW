    ...
    // Fix lỗi modal chồng lên nhau
    document.addEventListener('DOMContentLoaded', function() {
        // Xử lý nút "Xóa giỏ hàng" đặc biệt
        ...
        if (clearCartBtn) {
            clearCartBtn.addEventListener('click', function(event) {
                ...
                if (cartModalElement) {
                    // Đóng modal
                    bootstrap.Modal.getInstance(cartModalElement)?.hide();
...
// Hiển thị modal đăng nhập - cần sửa triệt để hơn
